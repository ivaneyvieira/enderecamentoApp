 ...
 * Boots the app:
 *
 * * Makes sure that the database is up-to-date, by running migration scripts with Flyway.
 *   This will work even in cluster as Flyway
...
class Bootstrap : ServletContextListener {
  override fun contextInitialized(sce: ServletContextEvent?) {
    ...
    VaadinOnKotlin.dataSourceConfig.apply {
      ...
      jdbcUrl = "jdbc:mysql://localhost:3306/dep_endereco"
      username = "root"
      password = ""
    }
